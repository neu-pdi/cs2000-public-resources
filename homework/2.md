...
Your first (of three) open-ended course projects begins this week. Like other homework, projects will be graded by code walks during lab (see [Code Walks](/syllabus#code-walks)). Since projects are large, each week there will be checkpoints due, which are a part of the project. 
