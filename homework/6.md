...
This HW, like all homeworks, is done on https://github.com and submitted on https://pawtograder.khoury.northeastern.edu. Go to Pawtograder to find the repository where the assignment should be done. The commit and push action automatically makes submissions to Pawtograder, where after a few minutes you will find automated feedback.
