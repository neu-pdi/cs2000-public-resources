...
While there may be automated feedback for parts of the "Programming Practice" section, **ALL OF YOUR GRADE IS DETERMINED BY THE CODE WALK THAT OCCURS DURING THE LAB FOLLOWING THE DEADLINE** (see [Code Walks](/syllabus#code-walks)).
...
Your second (of three) open-ended course projects begins this week. Like other homework, projects will be graded by code walks during lab (see [Code Walks](/syllabus#code-walks)). Since projects are large, each week there will be checkpoints due, which are a part of the project. 
