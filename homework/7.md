...
**Project 2, Checkpoint 2**, due this week, is:

- Make a plan for your interactive design, and write down (in English) which handlers you will have to use to handle the interactions.
- Create any static images you will need for your display; if all the images are generated dynamically, create some examples of them, so you know how to draw them. 
