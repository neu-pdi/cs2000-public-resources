...
## Problem 1
Define a table called `housing-table` with the appropriate column names and types, and use the function [`csv-from-file`](https://pyret.org/docs/horizon/csv.html#%28idx._%28gentag._393%29%29) to load the NYC housing data.
