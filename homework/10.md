...
Thursday, March 26, 2026 at 9PM (Boston)

## Submission

This HW, which is in **Python**, is done via VSCode on your computer, and submitted to Github via the Source Control tab. Go to Pawtograder to find the repository, which you can clone locally to do the assignment. Commits automatically make submissions, and feedback can be viewed on Pawtograder.
