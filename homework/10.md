...
From [Lab 2](/lab/2), implement `myencryptor1`, `myencryptor2`, and `myencryptor3` in Python. Note that they should behave the same as the Pyret functions you wrote in lab.