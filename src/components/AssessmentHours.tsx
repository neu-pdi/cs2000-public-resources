...
/**
 * Minimal RFC 4180 parser. Needed rather than a split on commas because cells hold
 * embedded newlines (one line per time and per room) and are therefore quoted.
 */
export function parseCsv(text: string): string[][] {
  ...
  // Normalise line endings first: the export uses CRLF between rows, and cells with
  // line breaks may contain either.
