    ...
    weeks: [
      ...
      },
      {
        ...
        days: [
          ...
          { day: 21, skills: [1], lectures: [{ label: 'Class 6', href: '/days/6' }] },
          { day: 22, skills: [1], lab: { label: 'Lab 2', href: '/lab/2' } },
          { day: 23, skills: [1], lectures: [{ label: 'Class 7', href: '/days/7' }] },
          { day: 24, skills: [1], lectures: [{ label: 'Class 8', href: '/days/8' }] },
          { day: 25, skills: [1] },
          { day: 26 },
        ],
      },
      {
        ...
        days: [
          ...
          { day: 28, skills: [1, 11, 12], lectures: [{ label: 'Class 9', href: '/days/9' }] },
          { day: 29, skills: [1, 11, 12], lab: { label: 'Lab 3', href: '/lab/3' } },
          { day: 30, skills: [1, 11, 12], lectures: [{ label: 'Class 10', href: '/days/10' }] },
          { day: 1, skills: [1, 11, 12], lectures: [{ label: 'Class 11', href: '/days/11' }] },
          { day: 2, skills: [1, 11, 12] },
          { day: 3 },
        ],
      },
    ],
    ...
    weeks: [
      {
        ...
        days: [
          ...
          { day: 5, skills: [1, 2, 11, 12], lectures: [{ label: 'Class 12', href: '/days/12' }] },
          { day: 6, skills: [1, 2, 11, 12], lab: { label: 'Lab 4', href: '/lab/4' } },
          { day: 7, skills: [1, 2, 11, 12], lectures: [{ label: 'Class 13', href: '/days/13' }] },
          {
            day: 8,
            skills: [1, 2, 11, 12],
            lectures: [{ label: 'Skill Day', href: '/skills/#skill-days-in-class' }],
          },
          { day: 9, skills: [1, 2, 11, 12] },
          { day: 10 },
        ],
      },
      {
        ...
        days: [
          ...
          { day: 13, skills: [2, 11, 12], lab: { label: 'Lab 5', href: '/lab/5' } },
          { day: 14, skills: [2, 11, 12], lectures: [{ label: 'Class 14', href: '/days/14' }] },
          { day: 15, skills: [2, 11, 12], lectures: [{ label: 'Class 15', href: '/days/15' }] },
          { day: 16, skills: [2, 11, 12] },
          { day: 17 },
        ],
      },
      {
...
Lectures meet **Monday, Wednesday, and Thursday**. Labs meet **Tuesday**. Homework is due **Sunday** (Anywhere-on-Earth).

**Colored stripes** at the bottom of each day indicate which skills are assessable during office hours on that day. Past days are faded.

<SkillCalendar data={calendarData} />
