...
Please create a table based on the data available at `https://raw.githubusercontent.com/neu-pdi/cs2000-public-resources/refs/heads/main/static/suppert/customer-data.csv`, which you should load (using `csv-table-url`) -- you will use this for the rest of the lab.
