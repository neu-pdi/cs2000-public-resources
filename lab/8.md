...
Design a function `oldest-birth-year` that finds the birth yera of the oldest person in the tree (the person with the smallest birth year). If the tree is empty, return 2050 (a currently impossible birth year).
