...
- **Discussion Questions:**
  - How does this iterative approach compare with recursive solutions?
  - What are the advantages or potential pitfalls of using mutable state for list processing?

- **Exit Ticket:**
  - Each student writes a brief explanation of one function they implemented today and describes the role of its accumulator variable.
