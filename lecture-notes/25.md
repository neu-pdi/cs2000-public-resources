...
- **Do Now:**
  - Show a simple Pyret function (e.g., a gadget cost calculator) and ask students what parts they expect to change when converting to Python.
...
- **Exit Ticket:**
  - Students write a short explanation (2–3 sentences) about one major notational difference between Pyret and Python and why it matters.
- **Preview Next Lecture:**
  - “Next, we’ll look at how to create and process lists in Python—and we’ll compare these approaches with the recursive and for‑each methods you already know from Pyret.”
