...
sidebar_position: 26
day_number: 26
title: Day 26 - Iteration in Python
---
...
### Supplementary Videos: [For Loops in Python](https://northeastern.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=90dae722-1c52-43d4-9028-b38c00e864e4)
...
1. Design a Python function `all_with_letter(words: list[str], letter: str) -> list[str]` that returns all words containing the given letter. In Python, you can check if a string contains a letter using `letter in word`.
