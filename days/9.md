...
1. Extract the name of the item that is closest to the player. Note that if you want to `order-by`, you need to convert it to an `ExactNum` with `num-to-rational`.
