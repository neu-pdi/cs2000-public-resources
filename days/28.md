...
## Pre-reading: [12.1](%7B%7BDCIC_DOMAIN%7D%7D/mutating-structures.html)
...
1. Analyze this Pyret code. What gets printed and why?
   ...
   box2!value
   ```
1. Draw the program directory and heap for this scenario:
   ```python
...
1. Trace this Pyret function through multiple calls:
   ...
   result1 == result2
   ```
1. Analyze this Python dataclass example:
   ```python
   from dataclasses import dataclass
