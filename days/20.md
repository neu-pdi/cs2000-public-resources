...
[Recursive Functions By Examples](https://northeastern.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=5a4d03ee-ea9e-4fd3-8d53-b3690183b12b)
...
1. Design a function `strings-less-than` that, given a list of strings as input,
  returns a list of strings that only includes those in the input whose length
   was less than a constant `LEN-LIMIT`.
