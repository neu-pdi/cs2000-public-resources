...
## Pre-reading: [4.1.3](https://dcic-world.org/2024-09-03/intro-tabular-data.html#%28part._.Functions_over_.Rows%29)
...
- Better is to define a function that checks if an order is high-value, and then 
...
- Write a function `is-morning` that checks if the `"time"` column in a row
