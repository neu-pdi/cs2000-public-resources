...
- TASK (IMPORTANT): create an account on github.com (if you don't already have one). ~~Verify as a student at https://github.com/education/students.~~ (The student verification second step is no longer required)
