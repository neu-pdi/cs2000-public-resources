...
- [ ]  Install **Github Desktop**, configure it.
  ...
  In order to work on HW and Lab assignments, we need to be able to get the repositories from Github.com to your computer! 
  
  We will do that using **Github Desktop**.

  1. Download and install it from [https://desktop.github.com/download/](https://desktop.github.com/download/)

  2. Log in using your Github.com username and password. 

  3. To test that this worked, go to Pawtograder, find one of your HW assignments, click on the link to the github repository, 
    and then click on the green Code button and then click on "Open with Github Desktop".

    ![Github Desktop Clone](/img/githubclone.png)

  4. It should then open in Github Desktop, and it should prompt you for a place on your computer to place the repository, which by default may be something like a Github folder inside your Documents. Wherever you place it, remember this.

    ![Github Desktop Local](/img/githublocal.png)

  5. Click "Clone". This is the technical word that Git uses to mean "copy to my local computer". 

    If you get an error like this one:
    
    ![Github Desktop Error](/img/githuberror.png)

    Go to Settings menu and sign in to Github.com, and then go back to your web browser, click the Code button to close it anda click it again to open and try "Open with Github Desktop" again.

  6. Now click "Open in Visual Studio Code". This should bring up VSCode with your HW repository.

    ![Github Desktop Open](/img/githubopen.png)

  7. You can say "Yes, Trust the Authors"
  ...
  9. Whenever you want to commit & push, go back to Github Desktop. **DO NOT COMMIT & PUSH FROM WITHIN VSCODE**.

    Make sure the "Current Repository" in the top left has the HW you want to submit. It should have changed files below, and make sure they are check.d Then put a message
    under "Summary", and click "Commit N files to main".

    ![Github Desktop Commit](/img/githubcommit.png)

  10. Once you've committed all your changes, it will say "No local changes", and there will be a button to "push origin" -- this pushes your changes to github, and submits to pawtograder. **COMMITTING ALONE DOES NOT SUBMIT. YOU MUST PUSH!!!**

    ![Github Desktop Push](/img/githubpush.png)

    This button will go away once you have pushed. You can also click the "Fetch origin" button to confirm -- if you do work on Github.com, or if you work on another computer, you will need to do this to get the changes onto your computer.
