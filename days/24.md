...
***__WARNING: Do not execute random commands in this window.  This is an elevated command prompt and can do serious damage if used improperly.  The two commands in these instructions are safe to run.__***
...
Then, under Environment Managers, find your Venv as `.venv (3.XX)`.

**Windows Users who Installed Pandas and Pytest before changing execution policy**
...
Click the little icon that says "Manage Packages" when you hover over it:
