...
- [ ]  Install & Configure VSCode extensions: **Python**, **Pylint**, **Mypy Type Checker**
  ...
  4. Install MyPy Type Checker Extension
    ...
    e. Now, any missing or mismatched types will be reported in the "Problems" tab every time you save or open a file
      ...
      If MyPy is set up properly, then this code, added to our `scratch.py` file:
